...
async function handleStream(req, res) {
    ...
    let codec = TRANSCODE_CODEC.toLowerCase();
    ...
    if (strategy === 'nvenc') {
        ...
        if (codec === 'h265' || codec === 'hevc') vEncoder = 'hevc_nvenc';
        ...
        let vEncoder = 'libx264';
        if (codec === 'h265' || codec === 'hevc') vEncoder = 'libx265';
        else if (codec === 'av1') vEncoder = 'libsvtav1';
        ...
        if (codec === 'h265' || codec === 'hevc') vEncoder = 'hevc_qsv';
        ...
        if (codec === 'h265' || codec === 'hevc') vEncoder = 'hevc_vaapi';
